...
LANGUAGES = {
    "en": {
        ...
        "russian": "Русский",
        "close": "Close",
        "track_unavailable_status": "Track unavailable: {title}",
        "skip_unavailable": "Skipped: {title} (video unavailable)",
        "skip_network": "Skipped: {title} (network error)",
        "skip_timeout": "Skipped: {title} (timeout)",
        "network_recovered": "Network recovered, retrying enabled",
        "retrying": "Retrying: {title}",
    ...
    "ru": {
        ...
        "russian": "Русский",
        "close": "Закрыть",
        "track_unavailable_status": "Трек недоступен: {title}",
        "skip_unavailable": "Пропущен: {title} (видео недоступно)",
        "skip_network": "Пропущен: {title} (ошибка сети)",
        "skip_timeout": "Пропущен: {title} (таймаут)",
        "network_recovered": "Сеть восстановлена, повторные попытки разрешены",
        "retrying": "Повторная попытка: {title}",
